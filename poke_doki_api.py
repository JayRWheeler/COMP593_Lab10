...
def main():
    ...
    download_pokemon_image('ditto', r'C:\temp')
...
def download_pokemon_image(pokemon_name, save_dir):
    ...
    # Get all specific Pokemon Info
    pokemon_info = get_pokemon_info(pokemon_name)
    if pokemon_info is None:
        print('Error: Failed to retrieve.')
        return
    
    # Extract the artwork URL from the info dict.
    artwork_url = pokemon_info['sprites']['other']['official-artwork']['front_default']
    shiny_artwork_url = pokemon_info['sprites']['other']['official-artwork']['front_shiny']
